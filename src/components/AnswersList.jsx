import { Button, Form , Row , Col , Badge , Table } from "react-bootstrap";
...
function AnswersList(props) {
    ...
    return <div>
       ...
       <AnswerDetails answers={myAnswers} deleteAnswer={handleDelete} upVoteAnswer={handleVote} handleEdit={handleEdit} />
        ...
        <p><Button variant='success' onClick={handleAdd}>ADD</Button> <Button variant='secondary' onClick={handleClose}>CLOSE</Button></p>
    </div>
}
